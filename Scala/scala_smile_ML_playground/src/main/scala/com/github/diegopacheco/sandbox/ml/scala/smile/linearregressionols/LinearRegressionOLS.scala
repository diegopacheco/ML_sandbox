package com.github.diegopacheco.sandbox.ml.scala.smile.linearregressionols
...
object LinearRegressionOLS extends SimpleSwingApplication {
  
  val basePath = new File(".").getCanonicalPath  + "/src/main/resources/OLS_Regression.csv"
